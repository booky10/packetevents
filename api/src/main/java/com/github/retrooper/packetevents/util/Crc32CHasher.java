...
// copied from https://github.com/google/guava/blob/a1b3c06876803a0b0e5d2f16708e1328da1bac09/guava/src/com/google/common/hash/Crc32cHashFunction.java (apache 2.0 license)
@NullMarked
public final class Crc32CHasher {
    ...
    public static int update(int crc, byte b1, byte b2) {
    ...
    public static int updateFloat(int crc, float f) {
        return updateInt(crc, Float.floatToRawIntBits(f));
    }

    public static int updateDouble(int crc, double d) {
        return updateLong(crc, Double.doubleToRawLongBits(d));
    }
}
