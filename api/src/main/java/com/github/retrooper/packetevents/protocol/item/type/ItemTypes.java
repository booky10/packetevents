...
public final class ItemTypes {
     ...
     * @versions 26.3+
     */
    public static final ItemType STRIPPED_POPLAR_WOOD = builder("stripped_poplar_wood").setMaxAmount(64).setPlacedType(StateTypes.STRIPPED_POPLAR_WOOD).setAttributes(ItemAttribute.WOOD_TIER, ItemAttribute.FUEL).build();
    /**
     * @versions 26.3+
     */
    public static final ItemType POPLAR_WOOD = builder("poplar_wood").setMaxAmount(64).setPlacedType(StateTypes.POPLAR_WOOD).setAttributes(ItemAttribute.WOOD_TIER, ItemAttribute.FUEL).build();
    /**
     * @versions 26.3+
     */
     ...
     * @versions 26.3+
     */
    public static final ItemType WOODLAND_MANSION_MAP = builder("woodland_mansion_map").setMaxAmount(64).setAttributes(ItemAttribute.WOOD_TIER).build();
    /**
     * @versions 26.3+
     */
